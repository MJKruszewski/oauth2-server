...
function revokeToken(token) {
    ...
    if(typeof token === 'object') {
        return OAuthRefreshToken.deleteOne({
    ...
    return OAuthAuthorizationCode
        ...
        .then(function (authCodeModel) {
            ...
            return reCode = {
                code: code,
                client: client,
                expiresAt: authCodeModel.accessTokenExpiresAt,
...
function saveAuthorizationCode(code, client, user) {
    ...
    return OAuthAuthorizationCode
        .create({
            accessTokenExpiresAt: code.expiresAt,
            OAuthClient: client._id,
    ...
    return OAuthRefreshToken
        ...
        .then(function (savedRT) {
            ...
            return {
                ...
                refreshTokenExpiresAt: savedRT ? new Date(savedRT.accessTokenExpiresAt) : null,
